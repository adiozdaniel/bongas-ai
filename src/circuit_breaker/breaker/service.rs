//! Production-grade circuit breaker implementation logic.
...
use super::super::rolling_window::{RollingWindow, WindowSnapshot};
use super::super::state::{CircuitBreakerState, TransitionResult};

use super::error::CircuitBreakerError;
use super::models::CircuitBreakerHealth;
...
impl CircuitBreaker {
    ...
    pub(super) async fn acquire_permission<E>(&self) -> Result<CallContext, CircuitBreakerError<E>> {
    ...
    pub(super) fn check_recovery_timeout(&self) {
    ...
    pub(super) async fn execute_operation<F, Fut, T, E>(
        &self,
        operation: F,
        _start: Instant,
    ) -> ExecutionResult<T, E>
